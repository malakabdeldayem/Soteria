...
if __name__ == "__main__":
    name = input("Enter the you want to search.\n")
    searches = int(input("Enter how many searches you want to display.\n"))
    get_sites(name, searches)
